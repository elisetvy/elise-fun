...
function Banner() {
    ...
    const words = ["OBJECT-ORIENTED PROGRAMMING", "TAIL RECURSION", "REGULAR EXPRESSION", "TEST-DRIVEN DEVELOPMENT", "CROSS-ORIGIN RESOURCE SHARING", "HASH MAP", "READ THE FUCKING MANUAL", "PASCAL'S TRIANGLE", "BOGOSORT", "DIJKSTRA'S ALGORITHM"];
